...
load("~/Desktop/BodyTime_Final_Version/06_FinalDataset_2024/ht1.Rda")
...
```{r}
rm(list = ls(all = TRUE)) 
load("~/Desktop/BodyTime_Final_Version/06_FinalDataset_2024/ht2.Rda")
...
load("~/Desktop/BodyTime_Final_Version/06_FinalDataset_2024/ht4.Rda")

dup <- read.csv("~/Desktop/BodyTime_Final_Version/06_FinalDataset_2024/db_duplicate.csv") # 1450
colnames(dup) <- c("index", "duplicates")
